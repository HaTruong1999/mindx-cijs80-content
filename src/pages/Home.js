...
function Home() {
    ...
    return ( <>
        <div className='tab'>
            <div>
            <button className={typeProduct === 'ALL' ? 'active' : ''} onClick={() => handleFilterProduct('ALL')} >Tất cả</button>
            <button className={typeProduct === 'MEN' ? 'active' : ''} onClick={() => handleFilterProduct('MEN')} >Nam</button>
            <button className={typeProduct === 'WOMEN' ? 'active' : ''} onClick={() => handleFilterProduct('WOMEN')} >Nữ</button>
            </div>
        </div>   
